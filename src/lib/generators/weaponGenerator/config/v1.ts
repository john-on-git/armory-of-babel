            ...
            new ProviderElement('streak-indicator',
                {
                    ...
                    applicableTo: { any: gemChargeBarAcceptingParts }
                },
                /**
                        ...
                        return (
                            bluntWeaponShapeFamilies.includes(weapon.shape.group as (typeof bluntWeaponShapeFamilies)[number]) ?
                                [
                                    ...
                                    ...geodableWeaponShapes.includes(weapon.shape.particular as (typeof geodableWeaponShapes)[number]) ? [
    ...
    passives: {
        add: [
            ...
            new ProviderElement("laser-pointer",
                {
                    miscPower: true,
                    desc: "There's a button on the side of the weapon. Pressing it causes the tip to emit a harmless beam of light.",
                },
                {
